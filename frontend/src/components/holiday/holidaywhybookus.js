        ...
        <div className="bg-white min-h-screen flex flex-col items-center py-10">
            <div className="max-w-5xl w-full bg-white rounded-xl shadow-md p-8 mb-8 flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="flex-1">
                    <h1 className="text-xl font-bold mb-2 ">
                        Unforgettable Holiday Packages at Best Prices with TravelEase
                    </h1>
                    <p className="text-gray-700 mb-6">
                        TravelEase offers a wide variety of holiday packages to suit every type of traveler. Whether you’re looking for a relaxing beach holiday, an adventurous trek, or a cultural city tour, we have it all. Enjoy the best deals, carefully curated itineraries, and hassle-free bookings that make your holiday experience unforgettable.
                    </p>
            ...
            <div className="max-w-5xl w-full">
                <h2 className="text-2xl font-bold mb-4 max-sm:text-center">
                    Why Book Holidays with <span className="font-black">TravelEase.com?</span>
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="bg-white shadow p-4 rounded-xl">
                        ...
                        <div className="text-gray-500 text-xs">
                            TravelEase made our vacation planning easy and affordable.
                        </div>
