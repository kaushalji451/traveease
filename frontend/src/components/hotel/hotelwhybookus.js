        ...
        <div className="bg-white min-h-screen flex flex-col items-center py-10">
            <div className="max-w-5xl w-full bg-white rounded-xl shadow-md p-8 mb-8 flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="flex-1">
                    <h1 className="text-xl font-bold mb-2 ">
                        Cheapest Deals on Budget & Luxury Hotels are Available at TravelEase
                    </h1>
                    <p className="text-gray-700 mb-6">
                        Due to the huge influx of tourists in India, TravelEase offers a wide range of luxury, deluxe and budget hotels to them. Choose to stay in luxury and comfort with the greatest discounts available on hotel bookings. We list the classiest budget hotels on our site along with some of the prominent international hotel chains of India including Oberoi Group, ITC Group, Taj Group, Le Meridian Group and many others. Ranging from class hotels to luxury beach resorts, each hotel on our site gives you a memorable staying experience. Along with deluxe, budget and luxury hotels, TravelEase also displays a number of heritage hotels that offer you a royal stay. Enjoy cheap hotel deals for any destination with great savings.
                    </p>
            ...
            <div className="max-w-5xl w-full">
                <h2 className="text-2xl font-bold mb-4 max-sm:text-center">
                    Why Book Hotels with <span className="font-black">TravelEase.com?</span>
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="bg-white shadow p-4 rounded-xl">
                        ...
                        <div className="text-gray-500 text-xs">
                            My query where solved within very short period. Thank you travelease..
                        </div>
